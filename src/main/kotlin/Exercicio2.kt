fun main(){
    ...
    val letraDesejada = readln().trim().lowercase().firstOrNull()

    // Lê a linha com os nomes separados por espaço
    val nomesEntrada = readlnOrNull() ?: ""
    ...
    val nomesFiltrados = nomesClientes.filter { it.lowercase().startsWith(letraDesejada!!) }
